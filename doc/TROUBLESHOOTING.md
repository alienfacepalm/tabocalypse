...
- Select the directory that contains **`manifest.json` at its root** — for Chrome MV3 builds from this repo, that is usually `apps/extension/.output/chrome-mv3`, not the repo root and not `.output` alone.
