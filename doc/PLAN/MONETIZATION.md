...
## Technical design summary (Phases 1–4)
...
| —     | ~~Monthly supporter drop workflow~~ (dropped)                                                                           | PM-T079                    | A content cadence; removed under the no-scheduled-obligations rule. Remove from the board and run `pnpm pm:sync`.                                                                                                                                                                                                                                                                                     |
...
- `site/support.html`, `doc/STORE-LISTING.md`, and `PRIVACY.md` still describe a monthly supporter drop and must be brought in line with this document (tracked as separate edits).
