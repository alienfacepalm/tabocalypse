...
Safari does **not** use Chrome’s **Load unpacked** flow. You need an **MV3** extension folder (from this repo, `apps/extension/output/safari-mv3` or `chrome-mv3` after `pnpm run build`) and a **Mac** with **Xcode**.
